...
Single-user app behind an auth cookie: every path except /healthz and
/auth/login requires the session cookie; bare paths get the login page,
/api/* gets 401.
"""
import hashlib
import hmac
...
VOICE_URL = os.environ.get("VOICE_URL", "http://localhost:8001").rstrip("/")
HEART_VOICE = "k-heart"
