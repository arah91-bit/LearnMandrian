...
SEEDS["S5"] += [
    ...
    # Phase 6 batch — everyday concrete HSK4/5-boundary words, hand-checked
    ("冰淇淋", "bīng qí lín", "ice cream", [1, 2, 2]), ("三明治", "sān míng zhì", "sandwich", [1, 2, 4]),
    ("汉堡", "hàn bǎo", "hamburger", [4, 3]), ("沙拉", "shā lā", "salad", [1, 1]),
    ("蜂蜜", "fēng mì", "honey", [1, 4]),
    ("零食", "líng shí", "snacks", [2, 2]), ("口味", "kǒu wèi", "taste, preference", [3, 4]),
    ("青菜", "qīng cài", "greens", [1, 4]), ("辣椒", "là jiāo", "chili pepper", [4, 1]),
    ("厕所", "cè suǒ", "toilet", [4, 3]), ("阳光", "yáng guāng", "sunshine", [2, 1]),
    ("影子", "yǐng zi", "shadow", [3, 5]), ("拖鞋", "tuō xié", "slippers", [1, 2]),
    ("眼泪", "yǎn lèi", "tears", [3, 4]), ("嗓子", "sǎng zi", "throat, voice", [3, 5]),
    ("感受", "gǎn shòu", "feeling, impression", [3, 4]), ("心理", "xīn lǐ", "psychology, mind", [1, 3]),
    ("迟早", "chí zǎo", "sooner or later", [2, 3]), ("当时", "dāng shí", "at that time", [1, 2]),
    ("首先", "shǒu xiān", "first of all", [3, 1]), ("其次", "qí cì", "secondly", [2, 4]),
    ("收音机", "shōu yīn jī", "radio", [1, 1, 1]), ("大自然", "dà zì rán", "nature", [4, 4, 2]),
    ("景色", "jǐng sè", "scenery, view", [3, 4]), ("山顶", "shān dǐng", "mountaintop", [1, 3]),
    ("沙滩", "shā tān", "beach", [1, 1]), ("岛", "dǎo", "island", [3]),
    ("运气", "yùn qi", "luck", [4, 5]), ("惊喜", "jīng xǐ", "pleasant surprise", [1, 3]),
    ("玩笑", "wán xiào", "joke (开玩笑)", [2, 4]), ("幸运", "xìng yùn", "lucky", [4, 4]),
    ("人们", "rén men", "people (in general)", [2, 5]), ("女士", "nǚ shì", "lady, Ms.", [3, 4]),
    ("成人", "chéng rén", "adult", [2, 2]), ("打车", "dǎ chē", "to take a taxi", [3, 1]),
    ("开车", "kāi chē", "to drive", [1, 1]), ("骑车", "qí chē", "to ride a bike", [2, 1]),
    ("半夜", "bàn yè", "midnight", [4, 4]), ("商品", "shāng pǐn", "goods", [1, 3]),
    ("牌子", "pái zi", "brand; sign", [2, 5]), ("名牌", "míng pái", "famous brand", [2, 2]),
    ("亲切", "qīn qiè", "warm, kindly", [1, 4]), ("热心", "rè xīn", "warm-hearted, eager", [4, 1]),
    ("窗口", "chuāng kǒu", "window (counter)", [1, 3]), ("结账", "jié zhàng", "to pay the bill", [2, 4]),
    ("小费", "xiǎo fèi", "tip (gratuity)", [3, 4]), ("账单", "zhàng dān", "bill", [4, 1]),
    ("体重", "tǐ zhòng", "body weight", [3, 4]), ("身高", "shēn gāo", "height", [1, 1]),
    ("紧", "jǐn", "tight", [3]), ("满", "mǎn", "full", [3]),
    ("破", "pò", "broken, worn", [4]), ("湿", "shī", "wet", [1]),
    ("干", "gān", "dry", [1]), ("家乡", "jiā xiāng", "hometown", [1, 1]),
    ("老家", "lǎo jiā", "family home", [3, 1]), ("毛病", "máo bìng", "fault, defect", [2, 4]),
    ("优惠", "yōu huì", "discount, favorable", [1, 4]), ("大声", "dà shēng", "loudly", [4, 1]),
    ("小声", "xiǎo shēng", "quietly", [3, 1]), ("来自", "lái zì", "to come from", [2, 4]),
    ("碰到", "pèng dào", "to run into", [4, 4]), ("及格", "jí gé", "to pass (a test)", [2, 2]),
    ("满分", "mǎn fēn", "full marks", [3, 1]), ("分数", "fēn shù", "score", [1, 4]),
    ("剪刀", "jiǎn dāo", "scissors", [3, 1]), ("打雷", "dǎ léi", "to thunder", [3, 2]),
    ("闪电", "shǎn diàn", "lightning", [3, 4]), ("彩虹", "cǎi hóng", "rainbow", [3, 2]),
    ("熊", "xióng", "bear", [2]), ("狼", "láng", "wolf", [2]),
    ("蜜蜂", "mì fēng", "bee", [4, 1]), ("蝴蝶", "hú dié", "butterfly", [2, 2]),
    ("邮箱", "yóu xiāng", "mailbox; email", [2, 1]), ("地点", "dì diǎn", "location, venue", [4, 3]),
    ("日历", "rì lì", "calendar", [4, 4]), ("闹钟", "nào zhōng", "alarm clock", [4, 1]),
...
# Phase 7.3 — S5 to the 1500 milestone. HSK4-band words absent from every
# earlier batch and from the reader; hand-checked against the tone-mark tests.
SEEDS["S5"] += [
    ("爱情", "ài qíng", "romantic love", [4, 2]),
    ("包括", "bāo kuò", "to include", [1, 4]),
    ("保证", "bǎo zhèng", "to guarantee", [3, 4]),
    ("不得不", "bù dé bù", "to have no choice but", [4, 2, 4]),
    ("乘坐", "chéng zuò", "to ride, to take (transport)", [2, 4]),
    ("吃惊", "chī jīng", "to be shocked", [1, 1]),
    ("重新", "chóng xīn", "anew, again", [2, 1]),
    ("答案", "dá àn", "answer", [2, 4]),
    ("大约", "dà yuē", "approximately", [4, 1]),
    ("刀", "dāo", "knife", [1]),
    ("底", "dǐ", "bottom, base", [3]),
    ("动作", "dòng zuò", "movement, action", [4, 4]),
    ("儿童", "ér tóng", "children", [2, 2]),
    ("法律", "fǎ lǜ", "law", [3, 4]),
    ("否则", "fǒu zé", "otherwise", [3, 2]),
    ("符合", "fú hé", "to conform to", [2, 2]),
    ("父亲", "fù qīn", "father (formal)", [4, 1]),
    ("母亲", "mǔ qīn", "mother (formal)", [3, 1]),
    ("胳膊", "gē bo", "arm", [1, 5]),
    ("功夫", "gōng fu", "skill; kung fu", [1, 5]),
    ("购物", "gòu wù", "to shop", [4, 4]),
    ("关键", "guān jiàn", "key, crucial", [1, 4]),
    ("光", "guāng", "light", [1]),
    ("逛", "guàng", "to stroll, to wander", [4]),
    ("汗", "hàn", "sweat", [4]),
    ("好处", "hǎo chu", "benefit, advantage", [3, 5]),
    ("合格", "hé gé", "qualified, up to standard", [2, 2]),
    ("回忆", "huí yì", "to recall; memory", [2, 4]),
    ("火", "huǒ", "fire", [3]),
    ("获得", "huò dé", "to obtain, to gain", [4, 2]),
    ("技术", "jì shù", "technology, technique", [4, 4]),
    ("降低", "jiàng dī", "to lower", [4, 1]),
    ("节约", "jié yuē", "to economize", [2, 1]),
    ("进行", "jìn xíng", "to carry out", [4, 2]),
    ("竞争", "jìng zhēng", "to compete; competition", [4, 1]),
    ("究竟", "jiū jìng", "actually, in the end", [1, 4]),
    ("困", "kùn", "sleepy", [4]),
    ("懒", "lǎn", "lazy", [3]),
    ("浪费", "làng fèi", "to waste", [4, 4]),
    ("浪漫", "làng màn", "romantic", [4, 4]),
    ("理解", "lǐ jiě", "to understand", [3, 3]),
    ("理想", "lǐ xiǎng", "ideal", [3, 3]),
    ("厉害", "lì hai", "impressive; intense", [4, 5]),
    ("例如", "lì rú", "for example", [4, 2]),
    ("零钱", "líng qián", "small change", [2, 2]),
    ("留", "liú", "to stay; to keep", [2]),
    ("流行", "liú xíng", "popular, in fashion", [2, 2]),
    ("乱", "luàn", "messy, chaotic", [4]),
    ("美丽", "měi lì", "beautiful", [3, 4]),
    ("民族", "mín zú", "ethnic group, nation", [2, 2]),
    ("难受", "nán shòu", "to feel awful", [2, 4]),
    ("能力", "néng lì", "ability", [2, 4]),
    ("弄", "nòng", "to do, to handle", [4]),
    ("骗", "piàn", "to deceive", [4]),
    ("其中", "qí zhōng", "among which", [2, 1]),
    ("气候", "qì hòu", "climate", [4, 4]),
    ("敲", "qiāo", "to knock", [1]),
    ("穷", "qióng", "poor", [2]),
    ("全部", "quán bù", "all, whole", [2, 4]),
    ("缺少", "quē shǎo", "to lack", [1, 3]),
    ("任何", "rèn hé", "any", [4, 2]),
    ("伤心", "shāng xīn", "sad, heartbroken", [1, 1]),
    ("勺子", "sháo zi", "spoon", [2, 5]),
    ("剩", "shèng", "to remain, to be left", [4]),
    ("师傅", "shī fu", "master worker (address)", [1, 5]),
    ("实际", "shí jì", "actual, real", [2, 4]),
    ("实在", "shí zài", "really, honestly", [2, 4]),
    ("适合", "shì hé", "to suit", [4, 2]),
    ("受到", "shòu dào", "to receive (treatment)", [4, 4]),
    ("帅", "shuài", "handsome", [4]),
    ("随便", "suí biàn", "as one pleases, casual", [2, 4]),
    ("所有", "suǒ yǒu", "all", [3, 3]),
    ("提供", "tí gōng", "to provide", [2, 1]),
    ("挺", "tǐng", "quite, rather", [3]),
    ("同情", "tóng qíng", "to sympathize", [2, 2]),
    ("同时", "tóng shí", "at the same time", [2, 2]),
    ("响", "xiǎng", "to ring, to sound", [3]),
    ("辛苦", "xīn kǔ", "hard, toilsome", [1, 3]),
    ("信封", "xìn fēng", "envelope", [4, 1]),
    ("兴奋", "xīng fèn", "excited", [1, 4]),
    ("性别", "xìng bié", "gender", [4, 2]),
    ("许多", "xǔ duō", "many", [3, 1]),
    ("学期", "xué qī", "semester", [2, 1]),
    ("养成", "yǎng chéng", "to form (a habit)", [3, 2]),
    ("要是", "yào shi", "if", [4, 5]),
    ("页", "yè", "page", [4]),
    ("一切", "yí qiè", "everything, all", [2, 4]),
    ("以为", "yǐ wéi", "to (wrongly) think", [3, 2]),
    ("因此", "yīn cǐ", "therefore", [1, 3]),
    ("友谊", "yǒu yì", "friendship", [3, 4]),
    ("于是", "yú shì", "thereupon, so", [2, 4]),
    ("原来", "yuán lái", "originally; it turns out", [2, 2]),
    ("阅读", "yuè dú", "to read (texts)", [4, 2]),
    ("暂时", "zàn shí", "for the time being", [4, 2]),
    ("招聘", "zhāo pìn", "to recruit", [1, 4]),
    ("真正", "zhēn zhèng", "genuine, true", [1, 4]),
    ("正常", "zhèng cháng", "normal", [4, 2]),
    ("值得", "zhí de", "to be worth", [2, 5]),
    ("指", "zhǐ", "to point; finger", [3]),
    ("至少", "zhì shǎo", "at least", [4, 3]),
    ("重视", "zhòng shì", "to value, to take seriously", [4, 4]),
    ("著名", "zhù míng", "famous", [4, 2]),
    ("专业", "zhuān yè", "major, profession", [1, 4]),
    ("自然", "zì rán", "nature; natural", [4, 2]),
    ("自信", "zì xìn", "self-confident", [4, 4]),
    ("总结", "zǒng jié", "to summarize; summary", [3, 2]),
    ("作用", "zuò yòng", "effect, role", [4, 4]),
    ("棒", "bàng", "great, excellent", [4]),
    ("笨", "bèn", "clumsy, stupid", [4]),
    ("猜", "cāi", "to guess", [1]),
    ("醋", "cù", "vinegar", [4]),
    ("存", "cún", "to save, to deposit", [2]),
    ("当", "dāng", "to serve as, to be", [1]),
    ("倒", "dào", "to pour; upside down", [4]),
    ("顶", "dǐng", "top; measure for hats", [3]),
    ("份", "fèn", "portion, copy (measure)", [4]),
    ("富", "fù", "rich, wealthy", [4]),
    ("高级", "gāo jí", "high-grade, advanced", [1, 2]),
    ("鼓掌", "gǔ zhǎng", "to applaud", [3, 3]),
    ("海关", "hǎi guān", "customs (border)", [3, 1]),
    ("忽然", "hū rán", "suddenly", [1, 2]),
    ("互联网", "hù lián wǎng", "the internet", [4, 2, 3]),
    ("集合", "jí hé", "to assemble, to gather", [2, 2]),
    ("酱油", "jiàng yóu", "soy sauce", [4, 2]),
    ("京剧", "jīng jù", "Beijing opera", [1, 4]),
    ("久", "jiǔ", "long (in time)", [3]),
    ("烤", "kǎo", "to roast, to bake", [3]),
    ("棵", "kē", "measure word for trees", [1]),
    ("凉", "liáng", "cool, cold", [2]),
]

# Phase 7.3 — S6 groundwork: the HSK5 band's society/opinion/work-life
# vocabulary, first real batch toward the 1800 threshold.
SEEDS["S6"] += [
    ("爱护", "ài hù", "to care for, to cherish", [4, 4]),
    ("把握", "bǎ wò", "to grasp; certainty", [3, 4]),
    ("办理", "bàn lǐ", "to handle (procedures)", [4, 3]),
    ("傍晚", "bàng wǎn", "toward evening", [4, 3]),
    ("保持", "bǎo chí", "to maintain", [3, 2]),
    ("保留", "bǎo liú", "to retain; to reserve", [3, 2]),
    ("保险", "bǎo xiǎn", "insurance", [3, 3]),
    ("报道", "bào dào", "news report", [4, 4]),
    ("悲观", "bēi guān", "pessimistic", [1, 1]),
    ("背景", "bèi jǐng", "background", [4, 3]),
    ("本科", "běn kē", "undergraduate", [3, 1]),
    ("本领", "běn lǐng", "ability, skill", [3, 3]),
    ("本质", "běn zhì", "essence, nature", [3, 4]),
    ("比例", "bǐ lì", "proportion, ratio", [3, 4]),
    ("彼此", "bǐ cǐ", "each other", [3, 3]),
    ("必然", "bì rán", "inevitable", [4, 2]),
    ("必要", "bì yào", "necessary", [4, 4]),
    ("毕竟", "bì jìng", "after all", [4, 4]),
    ("避免", "bì miǎn", "to avoid", [4, 3]),
    ("表面", "biǎo miàn", "surface", [3, 4]),
    ("表明", "biǎo míng", "to make clear", [3, 2]),
    ("表情", "biǎo qíng", "facial expression", [3, 2]),
    ("表现", "biǎo xiàn", "performance; to show", [3, 4]),
    ("博物馆", "bó wù guǎn", "museum", [2, 4, 3]),
    ("部门", "bù mén", "department", [4, 2]),
    ("财产", "cái chǎn", "property, assets", [2, 3]),
    ("采访", "cǎi fǎng", "to interview", [3, 3]),
    ("采取", "cǎi qǔ", "to adopt (measures)", [3, 3]),
    ("参考", "cān kǎo", "to consult, reference", [1, 3]),
    ("参与", "cān yù", "to participate in", [1, 4]),
    ("操场", "cāo chǎng", "sports ground", [1, 3]),
    ("操心", "cāo xīn", "to worry about", [1, 1]),
    ("测验", "cè yàn", "test, quiz", [4, 4]),
    ("曾经", "céng jīng", "once, formerly", [2, 1]),
    ("差距", "chā jù", "gap, disparity", [1, 4]),
    ("产品", "chǎn pǐn", "product", [3, 3]),
    ("产生", "chǎn shēng", "to produce, to arise", [3, 1]),
    ("长途", "cháng tú", "long-distance", [2, 2]),
    ("常识", "cháng shí", "common sense", [2, 2]),
    ("彻底", "chè dǐ", "thorough", [4, 3]),
    ("沉默", "chén mò", "silent; silence", [2, 4]),
    ("称赞", "chēng zàn", "to praise", [1, 4]),
    ("成分", "chéng fèn", "component, ingredient", [2, 4]),
    ("成果", "chéng guǒ", "achievement, fruit", [2, 3]),
    ("成就", "chéng jiù", "accomplishment", [2, 4]),
    ("成立", "chéng lì", "to found, to establish", [2, 4]),
    ("成熟", "chéng shú", "mature", [2, 2]),
    ("成语", "chéng yǔ", "idiom (four-character)", [2, 3]),
    ("程度", "chéng dù", "degree, level", [2, 4]),
    ("程序", "chéng xù", "procedure; program", [2, 4]),
    ("持续", "chí xù", "to persist, to last", [2, 4]),
    ("充分", "chōng fèn", "ample, full", [1, 4]),
    ("充满", "chōng mǎn", "to be full of", [1, 3]),
    ("重复", "chóng fù", "to repeat", [2, 4]),
    ("宠物", "chǒng wù", "pet", [3, 4]),
    ("抽象", "chōu xiàng", "abstract", [1, 4]),
    ("出版", "chū bǎn", "to publish", [1, 3]),
    ("出色", "chū sè", "outstanding", [1, 4]),
    ("出席", "chū xí", "to attend (formally)", [1, 2]),
    ("处理", "chǔ lǐ", "to handle, to deal with", [3, 3]),
    ("传播", "chuán bō", "to spread, to disseminate", [2, 1]),
    ("传统", "chuán tǒng", "tradition; traditional", [2, 3]),
    ("创造", "chuàng zào", "to create", [4, 4]),
    ("此外", "cǐ wài", "besides, in addition", [3, 4]),
    ("刺激", "cì jī", "to stimulate; exciting", [4, 1]),
    ("匆忙", "cōng máng", "hurried", [1, 2]),
    ("从此", "cóng cǐ", "from then on", [2, 3]),
    ("从事", "cóng shì", "to be engaged in (work)", [2, 4]),
    ("促进", "cù jìn", "to promote, to advance", [4, 4]),
    ("存在", "cún zài", "to exist", [2, 4]),
    ("措施", "cuò shī", "measure, step", [4, 1]),
    ("打工", "dǎ gōng", "to work a casual job", [3, 1]),
    ("打交道", "dǎ jiāo dào", "to deal with (people)", [3, 1, 4]),
    ("代表", "dài biǎo", "representative; to represent", [4, 3]),
    ("代替", "dài tì", "to replace", [4, 4]),
    ("贷款", "dài kuǎn", "loan; to take a loan", [4, 3]),
    ("单纯", "dān chún", "simple, pure", [1, 2]),
    ("单位", "dān wèi", "work unit; unit", [1, 4]),
    ("担任", "dān rèn", "to hold (a post)", [1, 4]),
    ("道德", "dào dé", "morality", [4, 2]),
    ("道理", "dào lǐ", "reason, sense", [4, 3]),
    ("登记", "dēng jì", "to register", [1, 4]),
    ("等待", "děng dài", "to wait for", [3, 4]),
    ("地位", "dì wèi", "status, position", [4, 4]),
    ("地震", "dì zhèn", "earthquake", [4, 4]),
    ("独立", "dú lì", "independent", [2, 4]),
    ("独特", "dú tè", "unique", [2, 4]),
    ("对手", "duì shǒu", "opponent, rival", [4, 3]),
    ("对象", "duì xiàng", "object; partner", [4, 4]),
    ("发表", "fā biǎo", "to publish, to voice", [1, 3]),
    ("发挥", "fā huī", "to bring into play", [1, 1]),
    ("发明", "fā míng", "to invent; invention", [1, 2]),
    ("发言", "fā yán", "to speak (publicly)", [1, 2]),
    ("罚款", "fá kuǎn", "fine; to fine", [2, 3]),
    ("法院", "fǎ yuàn", "court of law", [3, 4]),
    ("反映", "fǎn yìng", "to reflect, to report", [3, 4]),
    ("范围", "fàn wéi", "scope, range", [4, 2]),
    ("方案", "fāng àn", "plan, scheme", [1, 4]),
    ("方式", "fāng shì", "way, manner", [1, 4]),
    ("妨碍", "fáng ài", "to hinder", [2, 4]),
    ("非", "fēi", "not, non-", [1]),
    ("分别", "fēn bié", "separately; to part", [1, 2]),
    ("分析", "fēn xī", "to analyze", [1, 1]),
    ("纷纷", "fēn fēn", "one after another", [1, 1]),
    ("风格", "fēng gé", "style", [1, 2]),
    ("风俗", "fēng sú", "custom", [1, 2]),
    ("风险", "fēng xiǎn", "risk", [1, 3]),
    ("讽刺", "fěng cì", "to satirize; irony", [3, 4]),
    ("否定", "fǒu dìng", "to negate, to deny", [3, 4]),
    ("幅", "fú", "measure word for paintings", [2]),
    ("辅导", "fǔ dǎo", "to tutor, to coach", [3, 3]),
    ("妇女", "fù nǚ", "women (collective)", [4, 3]),
    ("改革", "gǎi gé", "reform", [3, 2]),
    ("改进", "gǎi jìn", "to improve", [3, 4]),
    ("改善", "gǎi shàn", "to better, to improve", [3, 4]),
    ("概念", "gài niàn", "concept", [4, 4]),
    ("干活儿", "gàn huó r", "to do (manual) work", [4, 2, 5]),
    ("赶紧", "gǎn jǐn", "hurriedly, at once", [3, 3]),
    ("感想", "gǎn xiǎng", "reflections, thoughts", [3, 3]),
    ("个别", "gè bié", "individual; exceptional", [4, 2]),
    ("个人", "gè rén", "individual, personal", [4, 2]),
    ("个性", "gè xìng", "personality", [4, 4]),
    ("根", "gēn", "root", [1]),
    ("根本", "gēn běn", "fundamental; at all", [1, 3]),
    ("工业", "gōng yè", "industry", [1, 4]),
    ("公布", "gōng bù", "to announce publicly", [1, 4]),
    ("公开", "gōng kāi", "public, open", [1, 1]),
    ("公平", "gōng píng", "fair", [1, 2]),
    ("公民", "gōng mín", "citizen", [1, 2]),
    ("功能", "gōng néng", "function", [1, 2]),
    ("贡献", "gòng xiàn", "contribution; to contribute", [4, 4]),
    ("沟通", "gōu tōng", "to communicate", [1, 1]),
    ("构成", "gòu chéng", "to constitute", [4, 2]),
    ("观察", "guān chá", "to observe", [1, 2]),
    ("观点", "guān diǎn", "point of view", [1, 3]),
    ("观念", "guān niàn", "notion, concept", [1, 4]),
    ("规矩", "guī ju", "rules, etiquette", [1, 5]),
    ("规律", "guī lǜ", "law, pattern", [1, 4]),
    ("规模", "guī mó", "scale, scope", [1, 2]),
]
...
LISTENING_PASSAGES = {
    "S3": [
        {"zh": "我家后面有一条小路。每天早上我在那里跑步，晚上和朋友走路。",
         "qs": [{"q": "What is behind the speaker's home?",
                 "choices": ["a small road", "a river", "a market", "a school"], "a": 0},
                {"q": "What happens there in the mornings?",
                 "choices": ["running", "walking with friends", "picnics", "nothing"], "a": 0}]},
        {"zh": "我们学校很大，有很多学生和老师。我每天在学校学习汉语，中午在学校吃饭。",
         "qs": [{"q": "What is the school like?",
                 "choices": ["big, with many people", "small and quiet", "new and empty", "closed"], "a": 0},
                {"q": "What happens at noon?",
                 "choices": ["lunch at school", "going home", "a nap", "an exam"], "a": 0}]},
    ...
    "S4": [
        {"zh": "明天是妈妈的生日。我买了一个蛋糕，妹妹准备了礼物。我们晚上一起吃饭。",
         "qs": [{"q": "Whose birthday is tomorrow?",
                 "choices": ["mom's", "the sister's", "the speaker's", "a friend's"], "a": 0},
                {"q": "What did the speaker buy?",
                 "choices": ["a cake", "a gift", "flowers", "tickets"], "a": 0}]},
        {"zh": "我们公司搬家了，新办公室在地铁站附近，上班方便多了。不过附近的饭馆有点贵。",
         "qs": [{"q": "What changed at the company?",
                 "choices": ["it moved offices", "it closed", "new manager", "longer hours"], "a": 0},
                {"q": "What is the downside?",
                 "choices": ["pricey restaurants nearby", "no subway", "small rooms", "long commute"], "a": 0}]},
        {"zh": "冬天来了，天气一天比一天冷。记得多穿衣服，别感冒了。晚上早点睡觉，身体最重要。",
         "qs": [{"q": "What is the advice about clothes?",
                 "choices": ["wear more", "buy new ones", "wash them", "wear less"], "a": 0},
                {"q": "What matters most, per the speaker?",
                 "choices": ["health", "work", "money", "fashion"], "a": 0}]},
    ...
    "S5": [
        {"zh": "他第一次面试没有成功，很失望。朋友鼓励他：失败难免，重要的是坚持。后来他找到了很好的工作。",
         "qs": [{"q": "How did the first interview go?",
                 "choices": ["it failed", "it succeeded", "it was cancelled", "he was late"], "a": 0},
                {"q": "What did the friend say about failure?",
                 "choices": ["it's hard to avoid — persist", "give up early", "blame others", "try another city"], "a": 0}]},
        {"zh": "周末的音乐会票很快就卖完了。我们提前一个月预定，才买到两张。位置不错，就是有点远。",
         "qs": [{"q": "How did they get tickets?",
                 "choices": ["reserved a month early", "bought at the door", "won them", "borrowed them"], "a": 0},
                {"q": "What is the small complaint?",
                 "choices": ["seats a bit far", "too expensive", "bad music", "too loud"], "a": 0}]},
    ...
    "S6": [
        {"zh": "调查发现，现在的年轻人越来越喜欢住在大城市。机会多是主要原因，不过房租高、压力大也是事实。",
         "qs": [{"q": "What do young people increasingly prefer?",
                 "choices": ["living in big cities", "the countryside", "small towns", "living abroad"], "a": 0},
                {"q": "What is the main reason?",
                 "choices": ["more opportunities", "cheap rent", "clean air", "family"], "a": 0}]},
        {"zh": "有人说，学习外语最好的办法是每天使用它：读一点，听一点，说一点。方法简单，难的是每天。",
         "qs": [{"q": "What is the recommended method?",
                 "choices": ["use the language daily", "study grammar only", "one long session weekly", "memorize a dictionary"], "a": 0},
                {"q": "What is the hard part?",
                 "choices": ["doing it every day", "finding books", "pronunciation", "the cost"], "a": 0}]},
