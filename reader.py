...
TEXTS = [
    ...
    {"id": "r0-1", "level": "R0", "title": "一 二 三", "title_en": "Counting begins",
     "intro": "Your first three characters are pictures of counting rods — and 十 is ten. Tap each one and hear it.",
     "new_words": [("一", "yī", "one", [1]), ("二", "èr", "two", [4]),
                   ("三", "sān", "three", [1]), ("十", "shí", "ten", [2])],
     "sentences": [_s("一|yī|one"), _s("二|èr|two"), _s("三|sān|three"), _s("十|shí|ten")],
     "en": "One. Two. Three. Ten.",
     "qs": [{"q": "Which character means “ten”?", "choices": ["十", "三", "二", "一"], "a": 0},
            {"q": "How is 三 read?", "choices": ["sān", "shí", "èr", "yī"], "a": 0}]},
    {"id": "r0-2", "level": "R0", "title": "人 我 你 他", "title_en": "People",
    ...
    {"id": "r0-3", "level": "R0", "title": "大 小 好 口", "title_en": "Big, small, good",
    ...
    {"id": "r0-4", "level": "R0", "title": "日 月 山 水", "title_en": "Sun, moon, mountain, water",
    ...
    {"id": "r3-1", "level": "R3", "title": "在茶店", "title_en": "At the tea shop",
     "intro": "Your first conversation — buying tea, start to finish.",
     ...
     "sentences": [_s("你好|nǐ_hǎo|hello ！ 我|wǒ|I 要|yào|want 一|yì|one 杯|bēi|cup 茶|chá|tea 。", "安娜"),
                   _s("好|hǎo|okay ！ 你|nǐ|you 要|yào|want 大|dà|big 杯|bēi|cup 吗|ma|question_word ？", "老板"),
                   _s("要|yào|want 大|dà|big 杯|bēi|cup 。 多少|duō_shao|how_much 钱|qián|money ？", "安娜"),
                   _s("三|sān|three 块|kuài|yuan 。", "老板"),
                   _s("好|hǎo|okay ， 三|sān|three 块|kuài|yuan 。 谢谢|xiè_xie|thanks ！", "安娜")],
     "en": "Anna: Hello! I want a cup of tea. — Shopkeeper: Okay! Do you want a large cup? — Anna: A large one. How much? — Shopkeeper: Three yuan. — Anna: Okay, three yuan. Thanks!",
     "qs": [{"q": "What size does Anna choose?", "choices": ["large", "small", "medium", "none"], "a": 0},
            {"q": "How much does it cost?", "choices": ["3 yuan", "10 yuan", "1 yuan", "13 yuan"], "a": 0}]},
    ...
    {"id": "r3-3", "level": "R3", "title": "你家有几口人？", "title_en": "How many in your family?",
     ...
     "new_words": [("几", "jǐ", "how many", [3]), ("四", "sì", "four", [4]),
    ...
    {"id": "r4-3", "level": "R4", "title": "小猫要吃什么？", "title_en": "What does the kitten want?",
     ...
     "sentences": [_s("我|wǒ|my 家|jiā|family 的|de|'s 小|xiǎo|little 猫|māo|cat 很|hěn|very 好|hǎo|nice 。"),
                   ...
                   _s("我|wǒ|I 给|gěi|give 它|tā|it 鱼|yú|fish 。"),
     ...
     "en": "Our little cat is lovely. It doesn't eat rice. I give it fish. It looks at me and says: “Meow!” Mom says: the kitten really likes you!",
     "qs": [{"q": "What won't the cat eat?", "choices": ["rice", "fish", "tea", "anything"], "a": 0},
            {"q": "What does the speaker give it?", "choices": ["fish", "rice", "water", "milk"], "a": 0}]},
    ...
    {"id": "r5-1", "level": "R5", "title": "小马找朋友", "title_en": "The little horse looks for a friend",
     ...
     "new_words": [("马", "mǎ", "horse", [3]), ("找", "zhǎo", "to look for", [3]),
    ...
    {"id": "r6-1", "level": "R6", "title": "安娜去中国", "title_en": "Anna goes to China",
     ...
     "sentences": [_s("安娜|Ān_nà|Anna 很|hěn|really 喜欢|xǐ_huan|likes 汉语|Hàn_yǔ|Chinese 。"),
                   ...
                   _s("三|sān|third 月|yuè|month ， 她|tā|she 坐|zuò|takes 飞机|fēi_jī|airplane 去|qù|to 中国|Zhōng_guó|China 。"),
